 ...
 *
 * @author Dollyn RETRIA (@dollynretria)
 * @version 1.0.3
 */
...
// Project related.
var project                 = 'Portofolio'; // Project Name.
...
const imgPaths = {
  src: 'assets/images/',
  dist: 'assets/images/',
  spriteImg: 'assets/images/icons/*.png',
  spriteRetina: 'assets/images/icons-retina/*@2x.png'
}
...
gulp.task('sprite', function () {
  ...
  spriteData.css.pipe(gulp.dest('assets/sass/helpers/'));
});
 ...
 gulp.task( 'default', ['styles', 'customJS', 'sprite', 'browser-sync'], function () {
